...
*We are happy to annouce that our new model for synthetic data called [CTGAN](https://DAI-Lab.github.io/CTGAN) is opensourced. The new model is simpler and gives better performance on many datasets. *
